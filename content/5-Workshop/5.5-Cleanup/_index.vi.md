...
![clean-server](../../../static/images/5-Workshop/5.5-Cleanup/clean-server.png)
- Chọn JumpStart / Models: Chọn TelcoChurnModelGroup $\rightarrow$ Delete.
![clean-group](../../../static/images/5-Workshop/5.5-Cleanup/clean-group.png)
...
![clean-api](../../../static/images/5-Workshop/5.5-Cleanup/clean-api.png)
...
![clean-lambda](../../../static/images/5-Workshop/5.5-Cleanup/clean-lambda.png)
...
- Bấm Delete.
![clean-event](../../../static/images/5-Workshop/5.5-Cleanup/clean-event.png)

##### Xóa SNS Topic
- Truy cập Amazon SNS $\rightarrow$ Topics.
- Chọn Topic TelcoChurnAlerts $\rightarrow$ Bấm Delete.
![clean-sns](../../../static/images/5-Workshop/5.5-Cleanup/clean-sns.png)
- Vào mục Subscriptions $\rightarrow$ Xóa Subscription liên kết với email của bạn.
![clean-email](../../../static/images/5-Workshop/5.5-Cleanup/clean-email.png)
...
![empty-s3](../../../static/images/5-Workshop/5.5-Cleanup/empty-s3.png)
- Sau khi làm rỗng, chọn lại Bucket đó và bấm Delete để xóa Bucket khỏi hệ thống.
![delete-s3](../../../static/images/5-Workshop/5.5-Cleanup/delete-s3.png)
...
![disable](../../../static/images/5-Workshop/5.5-Cleanup/disable.png)
...
![acls](../../../static/images/5-Workshop/5.5-Cleanup/acls.png)
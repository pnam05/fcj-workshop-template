...
{{% notice info %}}
Cả 2 bài blog đều đã được đăng tải chính thức trên diễn đàn [AWS Study Group](https://www.facebook.com/groups/awsstudygroupfcj) — không gian trao đổi tri thức và kết nối cộng đồng kỹ sư AWS Cloud.
{{% /notice %}}